...
<t:genericpage>
	...
	<jsp:body>
		...
		<hr />
		<c:url var="action" value="/enrollStudent/update"></c:url>
		...
		<form:form method="post" action="${action}" modelAttribute="enrollStudent">
			<div class="form-group row">
				...
				<div class="col-md-4 ">
					<form:hidden path="enrId" class="form-control" />
			...
			<div class="form-group">
				<hr />
				<input type="submit" value="Update Enroll Student" class="btn btn-primary" />
