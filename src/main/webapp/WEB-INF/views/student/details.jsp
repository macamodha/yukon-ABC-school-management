...
<t:genericpage>
	...
	<jsp:body>
		...
		<div class="form-group" style="padding: 5px">
			...
			<div class="form-group row">
				<div class="col-md-2">
					<label class="font-weight-bold">Student Status </label>
				</div>
				<div class="col-md-4 ">
			...
			<div style="margin: 10px">
				<a href="<c:url value='/student/list' /> " class="btn btn-success">Return to list</a>
				<a href="<c:url value='/student/delete/${stuId}' /> "
