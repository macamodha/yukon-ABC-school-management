	...
	<jsp:body>
		...
		<div class="form-group" style="margin: 10px">
			<form:form method="post" action="${action}" modelAttribute="student">
				...
				<div class="form-group row">
					<div class="col-md-2">
						<form:label path="studentType" class="font-weight-bold">Student Type</form:label>
					</div>
					<div class="col-md-4 ">
						<form:select path="studentType" class="form-control dropdown-toggle" > 
					...
					<div class="col-md-6">
						<form:errors  path="studentType" class="text-danger" />
					</div>
				</div>
				<div class="form-group row">
					<div class="col-md-2">
						<form:label path="gender" class="font-weight-bold">Student Gender</form:label>
					</div>
					<div class="col-md-4 ">
				...
				<div class="form-group row">
					<div class="col-md-2">
						<form:label path="status" class="font-weight-bold">Student Status</form:label>
					</div>
					<div class="col-md-4 ">
				...
				<div class="form-group">
					...
					<a href="<c:url value='/student/list' />" class="btn btn-success">Return to Students</a>
				</div>
			</form:form>
		</div>
	</jsp:body>
